...
import org.usfirst.frc.team1391.robot.commands.LarryAndWinston;
...
public class Robot extends TimedRobot {
    ...
    public static NetworkTableEntry thor = limelight.getEntry("thor");
    public static NetworkTableEntry tvert = limelight.getEntry("tvert");
    public static NetworkTableEntry camtran = limelight.getEntry("camtran");
    ...
    public void teleopInit() {
        ...
        //System.out.println("Print statements work");
    ...
    public void teleopPeriodic() {
        ...
        double yaw = camtran.getDoubleArray(new double[] {})[4];
        
        //System.out.println("Dist in inch: " + 2.75/Math.tan(angleToTop));
        //System.out.println("Angle in rad: " + Math.acos((hor/vert)/2.7727));
        //System.out.println("H: " + hor + " V: " + vert + " H/V: " + hor/vert);
        //System.out.println("Angle in degrees: " + Math.acos((hor/vert)/2.7727)*180/Math.PI);
